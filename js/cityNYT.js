// old call
// cityNYTPlot(all_tmax_avg[0],all_summer_dates[0],all_summer_extents[0],all_tmax_avg_smoothed[0],all_tmin_avg[0],all_winter_dates[0],all_winter_extents[0],all_tmin_avg_smoothed[0],"#figure");
// new call
// var viz = cityNYT();
...
var cityNYT = function() {
    ...
    var plot = function(tmax_avg,summer_teletherm_date,summer_teletherm_extent,tmax_smoothed_js,tmin_avg,winter_teletherm_date,winter_teletherm_extent,tmin_smoothed_js,div) {
